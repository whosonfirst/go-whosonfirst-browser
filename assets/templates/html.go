...
func templatesHtmlIdHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/html/id.html", size: 9596, mode: os.FileMode(420), modTime: time.Unix(1576372544, 0)}
