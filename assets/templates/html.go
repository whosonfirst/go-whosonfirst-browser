...
func wwwTemplatesHtmlAltHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "www/templates/html/alt.html", size: 4130, mode: os.FileMode(420), modTime: time.Unix(1579367131, 0)}
...
func wwwTemplatesHtmlIdHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "www/templates/html/id.html", size: 4061, mode: os.FileMode(420), modTime: time.Unix(1579367051, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
