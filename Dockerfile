...
# docker run -p 6161:8080 -e AWS_ACCESS_KEY_ID='your-aws-key' -e AWS_SECRET_ACCESS_KEY='your-aws-secret' -e HOST='0.0.0.0' -e S3_BUCKET='example.com' -e S3_PREFIX='' -e S3_REGION='us-east-1' -e S3_CREDENTIALS='env:' -e MAPZEN_APIKEY-'your-mapzen-apikey' wof-staticd
